    ...
    public ReturnT<Map<String, String>> codeGenerate(@RequestBody ParamInfo paramInfo ) {
        ...
        try {
            ...
            switch (paramInfo.getDataType()){
                ...
                default : classInfo = TableParseUtil.processTableIntoClassInfo(paramInfo);
            }
            ...
            log.info("generator table:"+(classInfo.getTableName())
                    +",field size:"+((classInfo.getFieldList()==null)?"":classInfo.getFieldList().size()));
